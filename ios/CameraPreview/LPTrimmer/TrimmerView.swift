...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    // changed
     /// The masked corner radius selected  video
     @IBInspectable public var cornerRadious: CGFloat = 0.0{
         didSet {
             leftHandleView.layer.cornerRadius = cornerRadious
             rightHandleView.layer.cornerRadius = cornerRadious
    ...
    override func constrainAssetPreview() {
        assetPreview.backgroundColor = .black
    ...
    private func setupTrimmerView() {
        leftHandleView.backgroundColor = .black
        rightHandleView.backgroundColor = .black
        
        trimView.layer.borderWidth = 2.0
        // changed
        //  trimView.layer.cornerRadius = 2.0
         trimView.layer.cornerRadius = 12.0
...
public protocol TrimmerViewDelegate1: class {
    func didChangePositionBar(_ playerTime: CMTime)
    func positionBarStoppedMoving(_ playerTime: CMTime)
}
...
//@IBDesignable public class TrimmerView1: AVAssetTimeSelector {
//
//    // MARK: - Properties
//
//    // MARK: Color Customization
