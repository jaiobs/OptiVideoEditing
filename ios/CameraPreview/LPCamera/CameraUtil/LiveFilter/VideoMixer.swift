...
class VideoMixer {
    ...
    init() {
        ...
        let libraryFile = Bundle.main.path(forResource: "Mixer", ofType: "metallib")
...
//        let defaultLibrary = metalDevice.makeDefaultLibrary()!
        ...
        pipelineDescriptor.vertexFunction = myLibrary!.makeFunction(name: "vertexMixer")
        pipelineDescriptor.fragmentFunction = myLibrary!.makeFunction(name: "fragmentMixer")
