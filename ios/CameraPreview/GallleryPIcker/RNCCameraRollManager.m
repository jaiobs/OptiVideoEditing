                  ...
                  reject:(RCTPromiseRejectBlock)reject)
{
    ...
    requestPhotoLibraryAccess(reject, ^{
        void (^collectAsset)(PHAsset*, NSUInteger, BOOL*) = ^(PHAsset * _Nonnull asset, NSUInteger assetIdx, BOOL * _Nonnull stopAssets) {
            ...
            if ([assetMediaTypeLabel  isEqual: @"video"]){
                ...
                [[PHImageManager defaultManager] requestAVAssetForVideo:asset options:option resultHandler:^(AVAsset * avasset, AVAudioMix * audioMix, NSDictionary * info) {
                    resultAsset = (AVURLAsset *) avasset ;
                    
                    
                    if ([resultAsset isKindOfClass:[AVComposition class]] == true) {
                        NSLog(@"--------------");
                        assetUrl = false;
                    }else{
                        NSLog(@"%@", resultAsset.URL);
                        assetUrl = true;
                        dummyString = resultAsset.URL.absoluteString;
                    }
            ...
            }else if ([assetMediaTypeLabel  isEqual: @"image"]){
                ...
                [asset requestContentEditingInputWithOptions:editOptions completionHandler:^(PHContentEditingInput *contentEditingInput, NSDictionary *info) {
                    ...
                    if (contentEditingInput.fullSizeImageURL) {
                        dummyString = contentEditingInput.fullSizeImageURL.absoluteString;
                    }
