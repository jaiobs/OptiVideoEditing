package com.litpic.litpicsdkdroid.imageeditor.stickeroverlay;
...
public class StickerOverlayOnImage extends AppCompatImageView
    ...
    public StickerOverlayOnImage(Context context) {
        this(context, null);
    }

    public StickerOverlayOnImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public StickerOverlayOnImage(Context context, AttributeSet attrs, int defStyleAttr) {
