...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.internal.GlTextureDrawer;
...
public class SnapshotGlPictureRecorder extends SnapshotPictureRecorder {
    ...
    protected void takeFrame(@NonNull SurfaceTexture surfaceTexture,
        ...
        Matrix.rotateM(transform, 0, (rotation * 1f )+ mResult.rotation, 0, 0, 1); // Rotate to OUTPUT
