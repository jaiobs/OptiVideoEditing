package com.litpic.litpicsdkdroid.camerapreview.cameraview.preview;
...
public abstract class CameraPreview<T extends View, Output> {
    ...
    /**
     * Called by the hosting {@link com.litpic.litpicsdkdroid.camerapreview.cameraview.CameraView},
