package com.litpic.litpicsdkdroid.camerapreview.cameraview.engine;
...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.action.Action;
...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.action.CompletionCallback;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.action.LogAction;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.mappers.Camera2Mapper;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.meter.MeterAction;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.meter.MeterResetAction;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.offset.Axis;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.offset.Reference;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.options.Camera2Options;
...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.frame.FrameManager;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.frame.ImageFrameManager;
...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.internal.FpsRangeValidator;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.metering.MeteringRegions;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.picture.Full2PictureRecorder;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.picture.Snapshot2PictureRecorder;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.preview.RendererCameraPreview;
...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.video.Full2VideoRecorder;
import com.litpic.litpicsdkdroid.camerapreview.cameraview.video.SnapshotVideoRecorder;
...
public class Camera2Engine extends CameraBaseEngine implements
    ...
    protected Task<Void> onStartBind() {
        ...
        if (outputClass == SurfaceHolder.class) {
            ...
            throw new RuntimeException("Unknown CameraPreview output class."); // NOSONAR
        }
    ...
    public void onVideoRecordingEnd() {
        ...
        if (needsIssue549Workaround) {
            ...
            try { Thread.sleep(600); } catch (InterruptedException ignore) { // NOSONAR
            }
