...
import com.litpic.litpicsdkdroid.camerapreview.cameraview.engine.lock.LockAction;
...
public class Snapshot2PictureRecorder extends SnapshotGlPictureRecorder {
    ...
    @Override
    public void take() {
        if (!mActionNeeded && mOriginalFlashMode == CaptureRequest.FLASH_MODE_OFF &&
                (mOriginalAeMode == CaptureRequest.CONTROL_AE_MODE_OFF
                        || mOriginalAeMode == CaptureRequest.CONTROL_AE_MODE_ON) ) {
