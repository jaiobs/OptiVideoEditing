package com.litpic.litpicsdkdroid.videoeditor.stickeroverlay;
...
public class StickerOverlay extends AppCompatImageView
    ...
    public StickerOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public StickerOverlay(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onScaleEnd(ScaleGestureDetector scaleGestureDetector) {
        Log.d("@@@", "onScaleEnd - >" + scaleGestureDetector);
    }
