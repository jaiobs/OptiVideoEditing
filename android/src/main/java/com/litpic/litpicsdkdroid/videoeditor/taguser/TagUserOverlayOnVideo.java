package com.litpic.litpicsdkdroid.videoeditor.taguser;
...
public class TagUserOverlayOnVideo extends AppCompatImageView
    ...
    TextOverlay.OverLayListener removeOverlayViewListener;
    int screenWidth;
    int screenHeight;
    ...
    public TagUserOverlayOnVideo(Context context) {
        this(context, null);
    }

    public TagUserOverlayOnVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public TagUserOverlayOnVideo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setRemoveOverlayViewListener(TextOverlay.OverLayListener removeOverlayViewListener) {
