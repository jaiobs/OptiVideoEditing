...
public class AdjustableExoVideoPlayerModule extends ReactContextBaseJavaModule {

    public AdjustableExoVideoPlayerModule(@NonNull ReactApplicationContext reactContext) {
        super(reactContext);
    }
